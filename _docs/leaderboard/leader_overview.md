...
- **Paper**: The original paper describing the method (arXiv link is recommended. paper needs not be peer-reviewed). **If your method has any original component (e.g., XXX + YYY) that is more than any existing methods, you have to write a white paper describing it (e.g., how you exactly combine XXX and YYY).**
