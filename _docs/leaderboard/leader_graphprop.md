...
|:----:|:-----:|:------:|:-----:|:-----:|:-----:|-----:|:-----:|:-----:|
|  1  |  **SAT++ with Magnetic Laplacian**  | No | 0.2222 ± 0.0032   | 0.2044 ± 0.0020 |[Simon Geisler (TU Munich)](mailto:geisler@in.tum.de) | [Paper](https://www.cs.cit.tum.de/fileadmin/w00cfj/daml/code-transformer/TransformersMeetDirectedGraphs_DLG-AAAI23_paper_477.pdf), [Code](https://github.com/deepmind/digraph_transformer) | 14,378,069 | 4 Google Cloud TPUv4 | Jan 13, 2023 |
