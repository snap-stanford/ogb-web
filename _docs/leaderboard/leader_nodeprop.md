...
|:----:|:-----:|:------:|:-----:|:-----:|-----:|:-----:|:-----:|
|  1  |  **HGT (LADIES Sample)**  | 0.8560 ± 0.0040   | [Ziniu Hu](mailto:bull@cs.ucla.edu) | [Paper](https://arxiv.org/abs/2003.01332), [Code](https://github.com/acbull/pyHGT/tree/master/ogbn-products) | 2,025,573 | Tesla K80 (12GB GPU) | Jul 8, 2020 |
|  2  |  **DeeperGCN**  | 0.8098 ± 0.0020   | [Guohao Li - DeepGCNs.org](mailto:guohao.li@kaust.edu.sa) | [Paper](https://arxiv.org/abs/2006.07739), [Code](https://github.com/lightaime/deep_gcns_torch/tree/master/examples/ogb) | 253,743 | NVIDIA Tesla V100 (32GB GPU) | Jun 28, 2020 |
