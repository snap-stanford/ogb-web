...
In our **[paper](https://openreview.net/forum?id=qkcLxoC52kL&noteId=JiMrMKllK0J)**, we further perform an extensive baseline analysis on each dataset, implementing simple baseline models as well as advanced expressive models at scale.
...
#### **[Paper](https://openreview.net/forum?id=qkcLxoC52kL&noteId=JiMrMKllK0J)**

Details about our datasets and our initial baseline analysis are described in our **[OGB-LSC paper](https://openreview.net/forum?id=qkcLxoC52kL&noteId=JiMrMKllK0J)**.
