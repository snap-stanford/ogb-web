...
**Note:** A very small number of self-connecting edges are duplicated (see [here](https://github.com/snap-stanford/ogb/issues/41)); please remove them if necessary.
